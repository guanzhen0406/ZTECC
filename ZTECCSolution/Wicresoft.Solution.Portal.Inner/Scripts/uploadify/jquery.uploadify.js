    ...
    function f() {
        ...
        a = true; E = Z || null; B = { success: false, id: X }; var ae = c(X); if (ae) {
            ...
            var ad = M.ie && M.win ? "ActiveX" : "PlugIn",
                ac =
                "MMredirectURL=" + O.location.toString().replace(/&/g, "%26") + "&"
            "MMplayerType=" + ad + "&MMdoctitle=" + j.title; if (typeof ab.flashvars != D) {
                ab.flashvars += "&" + ac;
...
SWFUpload.Console.writeLine = function (d) {
    var b, a; try {
        ...
        if (!b) {
            ...
            b.style.width = "700px"; b.style.height = "350px";
            b.style.margin = "5px"; a.appendChild(b)
        }
        b.value += d + "\n"; b.scrollTop = b.scrollHeight - b.clientHeight
    } catch (c) {
        Dialog.alert("Exception: " + c.name + " Message: " + c.message)
    }
};
...
(function ($) {
            ...
            return this.each(function () {
                ...
                if (flashInstalled) {
                    ...
                    swfuploadify.queueData = {
                        ...
                        errorMsg: '文件添加到上传序列失败'//'Some files were not added to the queue:'
                    };
    ...
    var handlers = {
        ...
        onDialogOpen: function () {
            ...
            this.queueData.errorMsg = '文件添加到上传序列失败';//'Some files were not added to the queue:';
        ...
        onDialogClose: function (filesSelected, filesQueued, queueLength) {
            ...
            if (settings.auto) $('#' + settings.id).uploadifyFlash('upload', '*');
        },
                ...
                switch (errorCode) {
                    case SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED:
                        if (settings.queueSizeLimit > errorMsg) {
                            ...
                            this.queueData.errorMsg += '\n文件大小超出上传限制 (' + settings.queueSizeLimit + ').';
                            //this.queueData.errorMsg += '\nThe number of files selected exceeds the queue size limit (' + settings.queueSizeLimit + ').';
                        }
                        break;
                    case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
                        //this.queueData.errorMsg += '\nThe file "' + file.name + '" exceeds the size limit (' + settings.fileSizeLimit + ').';
                        this.queueData.errorMsg += '\n文件:"' + file.name + '"超出文件上传大小限制 (' + settings.fileSizeLimit + ').';
                        break;
                    ...
                    case SWFUpload.QUEUE_ERROR.INVALID_FILETYPE:
                        ...
                        this.queueData.errorMsg += '\n文件 "' + file.name + '" 不是可上传的有效类型 (' + settings.fileTypeDesc + ').';
                        break;
                }
            }
        ...
        onUploadError: function (file, errorCode, errorMsg) {
            ...
            switch (errorCode) {
                ...
                case SWFUpload.UPLOAD_ERROR.UPLOAD_LIMIT_EXCEEDED:
                    //Dialog.alert('The upload limit has been reached (' + errorMsg + ').');
    ...
    $.fn.uploadifyFlash = function (method) {
