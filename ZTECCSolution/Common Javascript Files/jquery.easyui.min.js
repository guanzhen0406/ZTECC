...
cc.push("<td class=\"datagrid-td-rownumber\" title=\"" + _73d + "\"><div class=\"datagrid-cell-rownumber\">" + _73d + "</div></td>");
}
...
//ffzhai
var tdTitle = "";
if (col.formatter && _73f) {
    tdTitle = col.formatter(_73f, _73c, _73b);
    if (/\</.test(tdTitle)) {
        tdTitle = _73f;
    }
}

cc.push("<td field=\"" + _73e + "\" " + cls + " " + _742 + " title='" + (tdTitle || _73f || "") + "'>");
var _742="";
if(!col.checkbox){
if(col.align){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"正在加载中,请稍等 ...",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowEvents:{mouseover:_5d1(true),mouseout:_5d1(false),click:_5d9,dblclick:_5e3,contextmenu:_5e7},rowStyler:function(_76a,_76b){
